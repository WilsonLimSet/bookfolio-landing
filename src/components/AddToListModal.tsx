            ...
            <div className="space-y-2">
              ...
              {showCreateForm ? (
                ...
                <button
                  ...
                  className="w-full p-3 border-2 border-dashed border-black/10 rounded-xl text-sm text-neutral-500 hover:border-neutral-300 hover:text-neutral-700 transition-colors flex items-center justify-center gap-2"
                >
                  ...
                  <button
                    ...
                    className={`w-full p-3 rounded-xl border text-left flex items-center gap-3 transition-colors ${
                      selectedLists.has(list.id)
                        ...
                        : "border-black/10 hover:border-neutral-300"
                    }`}
                  >
